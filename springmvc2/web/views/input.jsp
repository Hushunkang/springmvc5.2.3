...
<form action="testConversionServiceConverer" method="post">
	<!-- lastname-email-gender-department.id 例如：GG-gg@atguigu.com-0-101 -->
...
<!--  
    1.为什么使用form标签呢？
    可以更快速的开发出表单页面, 而且可以更方便的进行表单值的回显（在编辑操作的时候需要先进行表单回显，然后编辑提交表单）
    2.注意：
    可以通过modelAttribute属性指定域对象中的数据
...
<form:form action="${pageContext.request.contextPath }/emp" method="post" modelAttribute="employee">
	...
	③.在spring mvc的配置文件中添加mvc:annotation-driven标签
	④.需要在bean的属性上添加对应的注解
	⑤.在目标方法bean类型的前面添加@Valid注解
	2).验证出错转向到哪一个页面？
	注意：需校验的bean对象和其绑定结果对象或错误对象是成对出现的，它们之间不允许声明其他的形参
